...
<body>
	...
	<div id='cases'>
		...
		<div id='patient'>
			...
			<h3>- 누적 확진자 현황 (${fn:substring(stdDay,0,4)}.${fn:substring(stdDay,4,6)}.${fn:substring(stdDay,6,8)} ${kList[0].stdTime} 기준)</h3>
			...
			<div id='table3'>
				<div class='tr'>
					...
					<div class='td'>
						...
						<div class='tr'>
							<div class='td'>
								+<fmt:formatNumber value="${kList[0].todayDecide}" pattern="#,###" />
							</div>
							<div class='td'><fmt:formatNumber value="${cVo.localOccCnt}" pattern="#,###" /></div>
							<div class='td'><fmt:formatNumber value="${cVo.overFlowCnt}" pattern="#,###" /></div>
						</div>
					</div>
					...
					<div class='td'><fmt:formatNumber value="${kList[0].careCnt}" pattern="#,###" /></div>
					<div class='td'>+<fmt:formatNumber value="${kList[0].todayCare}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].deathCnt}" pattern="#,###" /></div>
					<div class='td'>+<fmt:formatNumber value="${kList[0].todayDeath}" pattern="#,###" /></div>
				</div>
			</div>
		</div>
		...
		<div id='test'>
			...
			<div id='table5'>
				<div class='tr'>
					<div class='td'><fmt:formatNumber value="${kList[0].careCnt}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].clearCnt}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].deathCnt}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].decideCnt}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].resultNegCnt}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].accExamCompCnt}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].examCnt}" pattern="#,###" /></div>
					<div class='td'><fmt:formatNumber value="${kList[0].accExamCompCnt + kList[0].examCnt}" pattern="#,###" /></div>
				</div>
			</div>
		</div>
			...
			<div id='table6'>
				...
				<c:forEach var='i' begin = '9' end = '10'>
					<div class='tr'>
						...
						<div class='td'><fmt:formatNumber value="${gaList[i].confCase}" pattern="#,###" /> (${gaList[i].confCaseRate})</div>
						<div class='td'><fmt:formatNumber value="${gaList[i].death}" pattern="#,###" /> (${gaList[i].deathRate})</div>
